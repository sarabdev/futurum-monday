  ...
  return (
    <>
      <button
        ...
        onClick={onClick}
      >
        {lightMode && <Image loading='eager' src="/burger-1.gif" width={20} height={20} alt="burger_icon" /> }
        {!lightMode && <Image loading='eager' src="/burger-1.gif" width={20} height={20} alt="burger_icon" /> }
...
/>}
    ...
    >
      ...
      {side === 'right' ? (<div style={{display:'flex'}}><IconPlus color='#808080' onClick={()=>{setIsPromptModal(true)}}/>{lightMode?<Image loading='eager' src="/burger-1.gif" width={20} height={20} onClick={onClick} alt="burger_icon" />:<Image loading='eager' src="/burger-1.gif" onClick={onClick} width={20} height={20} alt="burger_icon" />}</div>) :
       <div style={{display:'flex'}}>{lightMode ?<Image loading='eager' src="/burger-1.gif" width={20} height={20} onClick={onClick} alt="burger_icon" />:<Image loading='eager' src="/burger-1.gif"  onClick={onClick} width={20} height={20} alt="burger_icon" />}<IconPlus color='#808080' onClick={()=>{handleCreateItem();selectpromptbar()}}/></div>}
    </button>
    </>
  );
};
