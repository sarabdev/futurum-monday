  ...
  return (
    ...
    >
      <div className="relative m-auto flex p-4 text-base md:max-w-2xl md:gap-6 md:py-6 lg:max-w-2xl lg:px-0 xl:max-w-3xl">
        <div className="min-w-[60px] text-right font-bold">
          {message.role === 'assistant' ? (
          ...
          {message.role === 'user' ? (
            ...
            <div className="flex flex-row" >
              <MemoizedReactMarkdown
                ...
                components={{
                  ul({ children }) {
                    return <ul className='list' style={{color:'black'}}>{children}</ul>;
                  },
                  ol({ children }) {
                    return <ol className='list' style={{color:"black"}}>{children}</ol>;
                  },
                  h1({ children }) {
                    return <h1  style={{color:'black'}}>{children}</h1>;
                  },
                  h2({ children }) {
                    return <h2 style={{color:'black'}}>{children}</h2>;
                  },
                  h3({ children }) {
                    return <h3  style={{color:'black'}}>{children}</h3>;
                  },
                  h4({ children }) {
                    return <h4  style={{color:'black'}}>{children}</h4>;
                  },
                  h5({ children }) {
                    return <h5  style={{color:'black'}}>{children}</h5>;
                  },
                  h6({ children }) {
                    return <h6  style={{color:'black'}}>{children}</h6>;
                  },
                  a({ href, children }) {
                  ...
                  th({ children }) {
                    return (
                      <th className="break-words border border-black bg-black-500 px-3 py-1 text-black dark:border-white">
                        {children}
                      </th>
                    );
                  },
